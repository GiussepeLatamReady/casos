    ...
    function (search, log, fileModulo, runtime, recordModulo, config, encode, format, query) {
        ...
        function ObtenerParametrosYFeatures() {
            ...
            paramSubsi = objContext.getParameter({
                name: 'custscript_lmry_cr_esdest_vent_sub_mprd'
            });

            paramPeri = objContext.getParameter({
                name: 'custscript_lmry_cr_esdest_vent_per_mprd'
            });

            paramMulti = objContext.getParameter({
                name: 'custscript_lmry_cr_esdest_vent_mlb_mprd'
            });

            paramLog = objContext.getParameter({
                name: 'custscript_lmry_cr_esdest_vent_log_mprd'
            });
        ...
        function obtenerVentasEmpresasZF() {
            var ventasEmpresasZF = search.load({
        ...
        function generateExcel(arrayFinal) {
            ...
            strXLS += ' <Worksheet ss:Name="Estructura y Destino de las Ventas">';
            var globalLabels = getGlobalLabels();
            ...
            strXLS += ' <Worksheet ss:Name="Desglose de Ventas a Empresas de Zona Franca">';
            ...
            strXLS += ' <Worksheet ss:Name="Desglose Mensual de Ventas Locales">';
            ...
            var searchThirdMarketsSales = search.create({
                ...
                filters:
                    [
                        ...
                        ["mainline", "is", "F"],
                        "AND",
                        ["formulatext: CASE WHEN {customermain.custentity_lmry_emp_reg_zonas_francas}='F' THEN 1 ELSE 0 END", "is", "1"]
                    ],
                settings: [],
                columns:
                    [

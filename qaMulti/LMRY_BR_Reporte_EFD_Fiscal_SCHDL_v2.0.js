    ...
    */
    ...
    function GenerarBloque0() {
      ...
      for (var i = 0; i < ArrItem.length; i++) {
        ...
        if ((!R200[ID] && arr_valido.indexOf(ArrItem[i][9]) == -1 && (ArrItem[i][7].substring(0, 1) == '4' || ArrItem[i][7].substring(0, 1) == '5' || ArrItem[i][7].substring(0, 1) == '6') && ArrItem[i][ArrItem[i].length - 5] == 'NO')) {
          R200[ID] = {
            "codigo": ID,
            ...
            "tipo": ArrItem[i][5],
            "mcn": ArrItem[i][34],
            "Cambios": ArrItem[i][ArrItem[i].length - 3]
          };
        }
        ...
        if (!R200[ID] && arr_valido_c.indexOf(ArrItem[i][9]) == -1 && (ArrItem[i][7].substring(0, 1) == '1' || ArrItem[i][7].substring(0, 1) == '2' || ArrItem[i][7].substring(0, 1) == '3') && ArrItem[i][ArrItem[i].length - 9] == 'NO') {
          R200[ID] = {
            "codigo": ID,
            "descripcion": ArrItem[i][4],
            "unidad": ArrItem[i][3],
        ...
        if (ArrItem[i][7] != '' && (ArrItem[i][7].substring(0, 1) == '1' || ArrItem[i][7].substring(0, 1) == '2' || ArrItem[i][7].substring(0, 1) == '3' || ArrItem[i][7].substring(0, 1) == '4' || ArrItem[i][7].substring(0, 1) == '5' || ArrItem[i][7].substring(0, 1) == '6') && c_0400 == 'T' && (ArrItem[i][9] == '01' || ArrItem[i][9] == '1B' || ArrItem[i][9] == '04' || ArrItem[i][9] == '55' || ArrItem[i][9] == '65')) {
          ...
          if (ArrItem[i][ArrItem[i].length - 9] == 'NO') {
          ...
          if (ArrItem[i][ArrItem[i].length - 5] == 'NO') {
    ...
    function Generar0190() {
      ...
      for (var i = 0; i < ArrItem.length; i++) {
        ...
        ID = ArrItem[i][3];
        if ((!R190[ID] && ID != '' && arr_valido.indexOf(ArrItem[i][9]) == -1 && ArrItem[i][ArrItem[i].length - 5] == 'NO') || (!R190[ID] && ID != '' && arr_valido_c.indexOf(ArrItem[i][9]) == -1 && (ArrItem[i][7].substring(0, 1) == '1' || ArrItem[i][7].substring(0, 1) == '2' || ArrItem[i][7].substring(0, 1) == '3') && ArrItem[i][ArrItem[i].length - 9] == 'NO')) {
          R190[ID] = {
            "nombre": ID,
            "unidad": ArrItem[i][8]
          };

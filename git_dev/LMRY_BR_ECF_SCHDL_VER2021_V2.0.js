         ...
         if (saldoPerBloqueKJson[i] !== undefined) {
             ...
             for (var j = 0; j < ArrNewregistrok155.length; j++) {
                 ...
                 if (ArrNewregistrok155[j][0] == i) {
                     ...
                     totalStringK030 += "|K155|" + ArrNewregistrok155[j][1] + "|" + centroCosto + "|" + obtenerFormatoNumero(Number(saldoInicial)) + "|";
                     ...
                     totalStringK030 += obtenerFormatoNumero(Number(debito)) + "|" + obtenerFormatoNumero(Number(credito)) + "|" + obtenerFormatoNumero(Number(saldoFinal)) + "|";

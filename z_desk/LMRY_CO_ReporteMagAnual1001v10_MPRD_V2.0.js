    ...
    function(record, runtime, file, search, encode, format, log, config, libreria) {
        ...
        function generateExcel(objResult, shippingNumber) {
            ...
            */
            ...
            "Ret. Source Pract. VAT","Ret. Source Pract. Non-domiciled VAT"];
            } else if (language == 'pt'){
            ...
            "Ret. Fonte Pract. Iva Reg. Comum","Ret. Fonte Pract. Iva não domiciliado"];
            } else {
            ...
            "Ret. Fuente Pract. Iva Reg. Comun","Ret. Fuente Pract. Iva No Domiciliados"];
            }

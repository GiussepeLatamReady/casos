              ...
              if (feaForeignCurrency) {
                var search_acc = search.create({
                  ...
                  filters: [
                    ...
                    ['isadjustmentonly', 'is', 'F'], 'AND',
                    ["persubsidiarystatus", "anyof", "ACTIVE"]
                  ],
                ...
                var subsidiary_currency = search.lookupFields({
                  type: search.Type.SUBSIDIARY,
                  id: subsidiary,
                  columns: ["currency"],
                });
                var currencySubsidiary = subsidiary_currency.currency[0].value;
                if (currencySubsidiary == currency_per) {
                  var search_acc = search.create({
                    type: "accountingbook",
                    filters: [
                      ["status", "anyof", "ACTIVE"],
                      "AND", ["subsidiary", "anyof", subsidiary],
                      "AND", ["isadjustmentonly", "is", "F"], 'AND',
                      ["persubsidiarystatus", "anyof", "ACTIVE"]
                    ],
                    columns: ["internalid", "name"]
                  });

    ...
    function(record, runtime, file, email, search, format, log, task, config, libreria, libFeature) {
        ...
        function callScheduleScript(type) {
            ...
            if (type == 'rellamado') {
                ...
                params["custscript_lmry_br_ecd_mprd_m_subsi_2"] = paramSubsidiary;
                params["custscript_lmry_br_ecd_mprd_m_period_2"] = paramPeriod;
                params["custscript_lmry_br_ecd_mprd_m_multi_2"] = paramMultibook;
                params["custscript_lmry_br_ecd_mprd_m_idlog_2"] = paramLogId;
                params["custscript_lmry_br_ecd_mprd_m_idrep_2"] = paramReportId;
                params["custscript_lmry_br_ecd_mprd_m_dectype_2"] = paramDeclarationType;
                params["custscript_lmry_br_ecd_mprd_m_booktype_2"] = paramBookType;
                params["custscript_lmry_br_ecd_mprd_m_num_orden_2"] = paramNumOrder;
                params["custscript_lmry_br_ecd_mprd_m_idsfile_2"] = paramIdsFile;
                params["custscript_lmry_br_ecd_mprd_dateconstitu"] = paramDateC;

                scriptId = "customscript_lmry_br_ecd_mprd_map_2";

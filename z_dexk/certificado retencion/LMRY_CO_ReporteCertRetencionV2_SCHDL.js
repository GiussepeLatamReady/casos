...
function ObtieneRetencion(pBusqueda) {
    ...
    savedsearch.addColumn(new nlobjSearchColumn("internalid", "CUSTBODY_LMRY_MUNICIPALITY", "GROUP"));
            ...
            for (var i = 0; i < intLength; i++) {
                ...
                if (featuremultib == true || featuremultib == 'T') {
                    if (Number(objResult[i].getValue(columns[10])) < 0) {
                        arrAuxiliar[3] = Number(objResult[i].getValue(columns[10])) * (-1);
                    } else {
                        arrAuxiliar[3] = objResult[i].getValue(columns[10]);
                    }
                } else {
                    if (Number(objResult[i].getValue(columns[5])) < 0) {
                        arrAuxiliar[3] = Number(objResult[i].getValue(columns[5])) * (-1);
                    } else {
                        arrAuxiliar[3] = objResult[i].getValue(columns[5]);
                    }
                }
                //4.RETENCIoN
                ...
                //5.DESCRIPTION
                if (objResult[i].getValue(columns[7]) != null && objResult[i].getValue(columns[7]) != '- None -' && objResult[i].getValue(columns[7]) != 'undefined') {
